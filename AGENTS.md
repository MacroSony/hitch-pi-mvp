...
Read `docs/product-scope.md`, `docs/security-floor.md`, `docs/architecture.md`,
`docs/phase-0-inputs.md`, `docs/plan-review.md`, `PLAN.md`, and
`LUNA_HANDOFF.md` before implementation.

This is a deliberately concrete Pi/Telegram/WeChat product. Do not introduce a
generic agent platform, authorization framework, connector protocol, plugin
system, or configuration revision graph unless the accepted MVP documents are
changed first.
